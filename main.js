...
// --- FUNCIONALIDAD ACORDEÓN SERVICIOS (MEJORADA) --- //
document.addEventListener('DOMContentLoaded', () => {
    ...
    readMoreBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            currentWrapper.classList.toggle('details-open');

            if (currentWrapper.classList.contains('details-open')) {
